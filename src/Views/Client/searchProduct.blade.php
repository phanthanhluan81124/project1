    ...
    <main>
                                ...
                                @for ($i = 1; $i < $number + 1; $i++)
                                    <a
                                        href = "@php if(!empty($_GET['gia'])){
                                            echo BASE_URL . 'search?keyword='.$_GET['keyword'].'&gia='.$_GET['gia'].'&page=' . $i;
                                        }
                                        else {
                                            echo BASE_URL .'search?keyword='.$_GET['keyword'].'&page=' . $i;
                                        } @endphp 
                                    ">
        ...
        <script>
            ...
            $('#price').change(function() {
                ...
                if (selectedValue == "0") {
                    const keyword = params.get('keyword');
                    window.location.replace(URL + 'search?keyword=' + keyword)
                    // console.log(keyword);
                } else {
                    let url = URL + 'search' + location.search + selectedValue;
